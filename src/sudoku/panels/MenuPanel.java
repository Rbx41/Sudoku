...
public class MenuPanel extends JPanel /*implements MouseListener */{
    ...
    public void loadImages() {
        ...
        try {
            ...
            /*
            this.kontynuuj = ImageIO.read(new File(source+"kontynuuj.png"));
            this.wczytajGre = ImageIO.read(new File(source+"wczytajGre.png"));
            this.nowaGra = ImageIO.read(new File(source+"nowaGra.png"));
            this.zasady = ImageIO.read(new File(source+"zasady.png"));

            this.kontynuuj2 = ImageIO.read(new File(source+"kontynuuj2.png"));
            this.wczytajGre2 = ImageIO.read(new File(source+"wczytajGre2.png"));
            this.nowaGra2 = ImageIO.read(new File(source+"nowaGra2.png"));
            this.zasady2 = ImageIO.read(new File(source+"zasady2.png"));
            */
